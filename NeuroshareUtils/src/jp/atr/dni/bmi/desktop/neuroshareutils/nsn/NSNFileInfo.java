 ...
 * @version 2011/01/13
 */
public class NSNFileInfo {

    private String szFileType;
    private int dwEntityCount;
    private double dTimeStampResolution;
    private double dTimeSpan;
    private String szAppName;
    private int dwTime_Year;
    private int dwTime_Month;
    private int dwTime_DayOfWeek;
    private int dwTime_Day;
    private int dwTime_Hour;
    private int dwTime_Min;
    private int dwTime_Sec;
    private int dwTime_MilliSec;
    private String szFileComment;
    ...
    private void setDwTime_Year(int dwTimeYear) {
        if (dwTimeYear >= 0) {
            ...
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeYear));
        }
    }
    ...
    private void setDwTime_Month(int dwTimeMonth) {
        if (dwTimeMonth >= 1 && dwTimeMonth <= 12) {
            ...
            // Display message.
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeMonth));
        }
    }
    ...
    private void setDwTime_DayOfWeek(int dwTimeDayOfWeek) {
        if (dwTimeDayOfWeek >= 0 && dwTimeDayOfWeek <= 6) {
            ...
            // Display message.
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeDayOfWeek));
        }
    }
    ...
    private void setDwTime_Day(int dwTimeDay) {
        if (dwTimeDay >= 1 && dwTimeDay <= 31) {
            ...
            // Display message.
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeDay));
        }
    }
    ...
    private void setDwTime_Hour(int dwTimeHour) {
        if (dwTimeHour >= 0 && dwTimeHour <= 23) {
            ...
            // Display message.
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeHour));
        }
    }
    ...
    private void setDwTime_Min(int dwTimeMin) {
        if (dwTimeMin >= 0 && dwTimeMin <= 59) {
            ...
            // Display message.
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeMin));
        }
    }
    ...
    private void setDwTime_Sec(int dwTimeSec) {
        if (dwTimeSec >= 0 && dwTimeSec <= 59) {
            ...
            // Display message.
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeSec));
        }
    }
    ...
    private void setDwTime_MilliSec(int dwTimeMilliSec) {
        if (dwTimeMilliSec >= 0 && dwTimeMilliSec <= 1000) {
            ...
            // Display message.
            Logger.getLogger(Logger.GLOBAL_LOGGER_NAME).info(
                    new ConstantMessages().getOutOfRange((double) dwTimeMilliSec));
        }
    }
     ...
     * @return members
     */
    public NSAFileInfo getMembers() {
        return new NSAFileInfo(this.getSzFileType(), this.getDTimeStampResolution(), this.getDTimeSpan(), this.getSzAppName(), this.getDwTime_Year(), this.getDwTime_Month(), this.getDwTime_DayOfWeek(), this.getDwTime_Day(), this.getDwTime_Hour(), this.getDwTime_Min(), this.getDwTime_Sec(), this.getDwTime_MilliSec(), this.getSzFileComment());
    }
     ...
     * @return
     */
    public int setMembers(NSAFileInfo nsaFileInfo) {
