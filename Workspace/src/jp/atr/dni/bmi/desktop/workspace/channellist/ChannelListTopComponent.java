package jp.atr.dni.bmi.desktop.workspace.channellist;
...
//       System.out.println("channel list top comp result chg");
      ...
      if (!c.isEmpty()) {
         for (Iterator iter = c.iterator(); iter.hasNext();) {
            GeneralFileInfo gfi = (GeneralFileInfo) iter.next();
            if (gfi != null) {
               ...
               if (gfi.getFileType() == FileType.NSN) {
                  ...
                  for (int i = 0; i < nsf.getEntities().size(); i++) {
                     //Create a new channel based on the type of entity
                     ...
                     if (ch != null) {
                        unSelectedChannelList.add(i, ch);
                     }
                  }
               }
            }
